...
import (
	...
	tv2 "github.com/gptscript-ai/huma"
)
...
func TestSchemaUnmarshalJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: huma.Schema{
				Type:       "object",
				Properties: map[string]*huma.Schema{"name": {Type: "string"}},
		...
		},
		{
			...
			expected: huma.Schema{
				Type:       "object",
				Properties: map[string]*huma.Schema{"id": {Type: "integer"}},
				Nullable:   true,
			},
			expectError: false,
		},
